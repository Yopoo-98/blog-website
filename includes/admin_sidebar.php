...
<body>
  ...
  <div class="sidebar" id="sidebar">
   ...
   <div style="background-color: black;padding:10px;border-radius:10px"> 
    ...
    <a href="admin_blog_post.php">🏠 DASHBOARD</a>
    <a href="admin_add_posts.php"><i class="fa-solid fa-plus"></i> &nbsp;Add New Posts</a>
    <a href="add_new_user.php"><i class="fa-solid fa-user-plus"></i>&nbsp;Add New User</a>
    <a href="admin_posts_only.php"><i class="fa-solid fa-plus"></i> &nbsp;My Posts</a>
    <a href="admin_manage_posts.php"><i class="fa-solid fa-hands-holding-circle"></i> Manage Posts</a>
    <a href="admin_manage_users.php"><i class="fa-solid fa-hands-holding-circle"></i> Manage Users</a>
    
    
    <a href="admin_set_profile.php">⚙️ Settings</a>
