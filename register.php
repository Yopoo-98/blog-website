                ...
                <div class="container " >
                    <div class="row ">
                        ...
                        <div class="col-4">
                            ...
                            <form action="insert_user.php" method="post" autocomplete="off" enctype="multipart/form-data">
                            <h5 style="text-align: center;color:brown;font-weight:bold">USER REGISTRATION</h5><br>
                               ...
                               <input type="email" class="form-control" placeholder="Enter Email" name="email" style="border:2px solid brown" required>
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col">
                                             <p class="fs-5 text-success"><span><a href="login.php" style="text-decoration:none;color:red">Login</a></p>
                                        </div>
                                        <div class="col">
