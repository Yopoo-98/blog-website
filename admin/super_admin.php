            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <a href="view_all_posts.php"><h3>View All Posts</h3></a>
                    </div>
                </div>
              </div>
            </div><br><br>

      <h2 style="text-align: center;color:coral">MY POSTS <hr></h2>
            ...
            <table id="datatableid" class="table"  style="border:2px solid black; background-color:gray;" >
              ...
              <tbody id="table-body" class=" table" style="color:navy; font-size: 16px; text-align: justify;">
                ...
                <?php
                     ...
                     $sql = "SELECT * FROM `blog_posts` inner join `admin` where blog_posts.admin_id = admin.admin_id AND admin.email = '".$_SESSION['email']."'   ";
                    $query= mysqli_query($conn, $sql);
                    while($row = mysqli_fetch_assoc($query)){
        ...
        <div class="row">
            ...
            <div class="col-md-8 " >  
                <div class="card-header">
                    <h4><a href="super_add_article.php"> Add New Article</a></h4>
