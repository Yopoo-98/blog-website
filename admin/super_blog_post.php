...
<body>
      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <a href="view_all_blog_posts.php" style="text-decoration: none;">
                    <div class="card-header" style="border-radius: 20px;text-align:center">
                        <h4>ACCESS ALL BLOGS POSTS</h4>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-4" >
                <form class="d-flex" role="search" action="super_search.php" method="post" style="text-align: right;">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-9" id="main-post">
            <?php
                 $sql = " SELECT * FROM blog_posts inner join admin where blog_posts.admin_id = admin.admin_id AND admin.email = '".$_SESSION['email']."' AND status = 1; ";
                 $query= mysqli_query($conn, $sql);
                    ...
                    ?>
                        <div class="row">
                            ...
                            <div class="col-md-7" id="post-division">
                                ...
                                <p><a href="super_view.php?view_id=<?php echo $row['post_id'];?>"><?php echo nl2br(strip_tags(substr($row['content'],0,200 )))?></a></p>

                                <div class="row">
                                    <div class="col"><h5 class=""><a href="super_view.php?view_id=<?php echo $row['post_id']?>" id="continue-reading"> Continue Reading...</a></h5></div>
                                </div>
            ...
            <h2 >Latest Posts</h2>
                <?php
                 ...
                 while($row = mysqli_fetch_assoc($query)){
                    ...
                    ?>
                        <br><div class="row">
                        <a href="super_view.php?view_id=<?php echo $row['post_id']?>" style="text-decoration:none">
