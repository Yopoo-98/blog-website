...
<head>
    ...
    <title>Super Admin All Posts</title>
     <!-- Bootstrap CSS -->
...
<body>
          ...
          while($row = mysqli_fetch_assoc($query)){
            ...
            <div class="container">
              <div class="row">
                ...
                <a href="super_admin.php"> <h3>Back</h3></a>
                    </div>
                </div>
                <div class="col-md-4">
      ...
      <h2 style="text-align: center;color:coral">ALL USERS POSTS <hr></h2>
            ...
            <table id="datatableid" class="table"  style="border:2px solid black; background-color:gray;" >
              <thead style="font-size:13px;" >
                <tr>
                  ...
                  <th class="text-dark" style="border: 1px solid black;background:white">Post Title</th>
                  <th class="text-dark" style="border: 1px solid black;background:white">Posted By</th>
                  <th class="text-dark" style="border: 1px solid black;background:white">Post Status</th>
                  <th class="text-dark" style="border: 1px solid black;background:white">Posted Date</th>
     ...
     the question mark and greater than sign comes first and the less than and php goes down */                  
                      ?>
                        <tr>
                          ...
                          <td class="text-dark" style="border: 1px solid black;background:white"><?php echo $row['fname'] . $row['lname'];?></td> 
                          <td class="text-dark" style="border: 1px solid black;background:white">
                          <?php
                          if($row['status']==1){
                            echo'<p><a href="activate_post.php?post_id=' . $row['post_id'].'&status=0" class="btn btn-success">Published</a></p>';
                          }else{
                            echo'<p><a href="activate_post.php?post_id=' . $row['post_id'].'&status=1" class="btn btn-danger">Pending</a></p>';
                          }
                          ...
                          <td style="border: 1px solid black;background:white;"><br>
                            <a href="super_update_post.php?update_id=<?php echo $row['post_id']?>" id="post-update">Update</a>
                            <a onclick="return confirm('Do You Really Want to Delete This Record? ')"  href="super_delete_post.php?delete_id=<?php echo $row['post_id']?>" id="post-delete">Delete</a> 
                          </td>
