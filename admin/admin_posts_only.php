                    ...
                    ?>
                        <div class="row">
                            <div class="col-md-2" id="post-image">
                              <a href="view.php?view_id=<?php echo $row['post_id'];?>"><img src="..\imagepost/<?php echo $row['content_image']?>"></a>
                            </div>
                            <div class="col-md-7" id="post-division">
                                
                                <h5 class="user_name">Author: <?php echo $fname . " ". $lname . ",  " . $date;?></h5>
                               
                                <h4 class="title">Title: <a href="view.php?view_id=<?php echo $row['post_id'];?>"><?php echo $title;?></a></h4>
                                <h5 class="description">Category: <a href="view.php?view_id=<?php echo $row['post_id'];?>"><?php echo $description?></a></h5>
                                <p><a href="view.php?view_id=<?php echo $row['post_id'];?>"><?php echo nl2br(strip_tags(substr($row['content'],0,200 )))?></a></p>

                               
                                <div class="row">
                                    <div class="col"><h5 class=""><a href="admin_view.php?view_id=<?php echo $row['post_id']?>" id="continue-reading"> Continue Reading...</a></h5></div>
                                </div>
                            </div>
                        </div><br><br><br>
                    <?php 
            ...
            <h2 >Latest Posts</h2>
                <?php
                 ...
                 while($row = mysqli_fetch_assoc($query)){
                    ...
                    ?>
                        <br><div class="row">
                            <a href="view.php?view_id=<?php echo $row['post_id']?>" style="text-decoration:none">
