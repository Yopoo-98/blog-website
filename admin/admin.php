      ...
      <div class="container-fluid" id="profile-pic-bg" ><br>
        <div class="row">
          ...
          while($row = mysqli_fetch_assoc($query)){
            ...
            ?>
             <h4 style="color:coral; font-weight:bold; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif"><?php echo $row['user_name']?></h4>
        ...
        <div class="row">
            ...
            <div class="col-md-8 " >  
                <div class="card-header">
                    <h4><a href="add_article.php"> Add New Article</a></h4>
                </div>   <br><br>
